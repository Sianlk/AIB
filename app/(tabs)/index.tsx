...
// AIB Platform | AI business automation and intelligence
...
const ACTIONS = [
  { id: '1', title: 'Workflow AI', icon: 'sparkles-outline' },
  { id: '2', title: 'Business Intelligence', icon: 'sparkles-outline' },
  { id: '3', title: 'RPA Engine', icon: 'sparkles-outline' },
  { id: '4', title: 'Process Automation', icon: 'sparkles-outline' },
  { id: '5', title: 'AI Reports', icon: 'sparkles-outline' },
];
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>AI business automation and intelligence</Text>
        </View>
