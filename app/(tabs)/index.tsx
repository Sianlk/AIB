...
const QUICK_ACTIONS = [
        { id: '1', title: 'Workflow AI', icon: 'sparkles-outline', color: Colors.primary },
        { id: '2', title: 'Business Intelligence', icon: 'sparkles-outline', color: Colors.primary },
        { id: '3', title: 'RPA Engine', icon: 'sparkles-outline', color: Colors.primary },
        { id: '4', title: 'Process Automation', icon: 'sparkles-outline', color: Colors.primary },
        { id: '5', title: 'AI Reports', icon: 'sparkles-outline', color: Colors.primary },
];
...
export default function HomeScreen() {
  ...
  async function handleAIQuery() {
    ...
    setLoading(true);
    Analytics.aiQuery(prompt, 'business automation');
    try {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>AI business automation & intelligence</Text>
        </View>
      ...
      <Card variant="ai" style={styles.aiCard}>
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiBadgeText}>AI — business automation</Text>
        </View>
        <TextInput
          style={styles.aiInput}
          placeholder={`Ask AIB Platform AI anything...`}
