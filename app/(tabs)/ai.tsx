...
// AIB Platform — AI Agents & Workforce
...
export default function AIScreen() {
  ...
  const [taskType, setTaskType] = useState('Workflow AI');
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Domain: business automation</Text>

      <Card variant="ai" style={styles.card}>
        <Text style={styles.label}>Task Type</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tagRow}>
          {['Workflow AI','Business Intelligence','RPA Engine','Process Automation','AI Reports'].map((f) => (
            <TouchableOpacity
              key={f}
