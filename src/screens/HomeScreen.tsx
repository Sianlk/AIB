    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.tagline}>AI Infrastructure for Builders</Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Quick Access</Text>
        <View key="0" style={styles.featureCard}>
          <Text style={styles.featureText}>AI Integration APIs</Text>
        </View>
        <View key="1" style={styles.featureCard}>
          <Text style={styles.featureText}>Model Deployment</Text>
        </View>
        <View key="2" style={styles.featureCard}>
          <Text style={styles.featureText}>Data Pipelines</Text>
        </View>
