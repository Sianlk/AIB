// Monetization & Subscription Engine — AIB Platform
...
export const PLANS: Record<Plan, PlanConfig> = {
  free: {
    ...
    features: [
      '10 AI requests/day',
      'Basic business automation features',
      'Community support',
    ],
  ...
  starter: {
    ...
    price_monthly: 9.99,
    price_annual: 7.99,
    sku_monthly: 'com.sianlk.aib.starter.monthly',
    sku_annual: 'com.sianlk.aib.starter.annual',
    features: [
      '100 AI requests/day',
      'All business automation features',
  ...
  pro: {
    ...
    price_monthly: 29.99,
    price_annual: 19.99,
    sku_monthly: 'com.sianlk.aib.pro.monthly',
    sku_annual: 'com.sianlk.aib.pro.annual',
    features: [
  ...
  enterprise: {
    ...
    price_monthly: 99.99,
    price_annual: 79.99,
    sku_monthly: 'com.sianlk.aib.enterprise.monthly',
    sku_annual: 'com.sianlk.aib.enterprise.annual',
    features: [
