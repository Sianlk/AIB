...
const s = StyleSheet.create({
  ...
  v_primary:   { backgroundColor: '#374151' },
  v_secondary: { backgroundColor: '#6B728033' },
  v_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#374151' },
  v_ghost:     { backgroundColor: 'transparent' },
  v_danger:    { backgroundColor: '#EF4444' },
  v_ai:        { backgroundColor: '#1F2937', borderWidth: 1, borderColor: '#6B7280' },
  lbl:    { fontSize: 14, fontWeight: '600' },
  lv_primary:   { color: '#FFFFFF' },
  lv_secondary: { color: '#1F2937' },
  lv_outline:   { color: '#374151' },
  lv_ghost:     { color: '#374151' },
