...
const styles = StyleSheet.create({
  ...
  // Variants
  variant_primary:   { backgroundColor: '#374151' },
  variant_secondary: { backgroundColor: '#6B728033' },
  variant_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#374151' },
  variant_ghost:     { backgroundColor: 'transparent' },
  variant_danger:    { backgroundColor: Colors.error },
  variant_ai:        { backgroundColor: '#1F2937', borderWidth: 1, borderColor: '#6B7280' },

  // Labels
  label: { ...Typography.button },
  label_primary:   { color: '#FFFFFF' },
  label_secondary: { color: '#1F2937' },
  label_outline:   { color: '#374151' },
  label_ghost:     { color: '#374151' },
