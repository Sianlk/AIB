...
<img src="assets/graphics/icon-1024.svg" width="120" alt="AIB Platform Icon" />

# AIB Platform

### AI Infrastructure for Builders

[![CI](https://github.com/Sianlk/AIB/actions/workflows/backend-ci.yml/badge.svg)](https://github.com/Sianlk/AIB/actions/workflows/backend-ci.yml)
[![Security Scan](https://github.com/Sianlk/AIB/actions/workflows/security-scan.yml/badge.svg)](https://github.com/Sianlk/AIB/actions/workflows/security-scan.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-iOS%20|%20Android-lightgrey.svg)](https://aibplatform.io)
[![FastAPI](https://img.shields.io/badge/backend-FastAPI-009688.svg)](https://fastapi.tiangolo.com)
[![React Native](https://img.shields.io/badge/mobile-React%20Native-61DAFB.svg)](https://reactnative.dev)

**AI, enterprise, infrastructure, SDK**

[Website](https://aibplatform.io) · [Privacy Policy](https://aibplatform.io/privacy) · [Support](https://aibplatform.io/support)
...
**AIB Platform** — AI Infrastructure for Builders
...
- **AI-Powered Core** — Intelligent automation and recommendations tailored to AI
...
```bash
# Clone the repo
git clone https://github.com/Sianlk/AIB.git
cd AIB
